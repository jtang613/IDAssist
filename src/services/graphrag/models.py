...
class EdgeType(str, Enum):
    ...
    - STRUCTURAL: Derived from disassembler analysis (call graph, xrefs, hierarchy)
    ...
    # ========================================
    # STRUCTURAL edges (from disassembler)
    # ========================================
    ...
    def is_structural(self) -> bool:
        """Check if this is a structural edge derived from the disassembler."""
        return self in {
